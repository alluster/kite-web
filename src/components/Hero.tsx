...
export const Hero = () => {
  return (
    <>
      <Container className="flex flex-wrap min-h-48 text-center justify-center lg:text-left ">
        <div className="flex items-center w-full lg:w-1/3">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl  font-medium font-sans tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-4xl xl:leading-tight dark:text-white">
				Take your procurement process to the next level with Kite.
            </h1>
